...
const ITEMS = [
  ...
  { to: "/character-dining", title: "Character Dining", desc: "Which meals are worth it, prices, and the 60-day booking window.", ready: true, icon: "fork" },
  { to: "/rainy-day", title: "Rainy Day Plan", desc: "What stays open, indoor rides ranked, the CityWalk fallback.", ready: true, icon: "cloud" },
