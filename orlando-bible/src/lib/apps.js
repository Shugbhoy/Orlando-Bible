...
export const APP_TIERS = [
  {
    ...
    apps: [
      { name: "MPC Mobile Passport", what: "Skip the immigration queue at the airport — the single best time-saver on arrival.", url: "https://www.cbp.gov/travel/us-citizens/mobile-passport-control", confirm: true },
      ...
      { name: "SunPass", what: "Prepay Florida tolls and dodge the hire-car admin fees that arrive weeks later.", url: "https://www.sunpass.com", confirm: true },
      { name: "Mears Connect", what: "Book shared airport transfers if you're not hiring a car.", url: "https://www.mearsconnect.com", confirm: true },
